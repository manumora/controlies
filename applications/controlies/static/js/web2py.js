(function($, undefined) {
  ...
  $.web2py = web2py = {
      ...
      web2py_websocket_stop: function(){
 	  wbsocket.close();
      },
      /* new from here */
      ...
      disableElement: function(el) {
        ...
        var disable_with_message = (typeof w2p_ajax_disable_with_message != 'undefined') ? w2p_ajax_disable_with_message : "Ejecutando...";
...
web2py_websocket_stop = jQuery.web2py.web2py_websocket_stop;
