...
(I||a.p.onHeaderClick.call(a,a.p.gridstate,d)))});return!1}),I&&(a.p.datatype="local",b(".ui-jqgrid-titlebar-close",c.cDiv).trigger("click")))}else b(c.cDiv).hide(),b(c.hDiv).addClass("ui-corner-top");b(c.hDiv).after(c.bDiv).mousemove(function(a){if(c.resizing)return c.dragMove(a),!1});b(".ui-jqgrid-labels",c.hDiv).bind("selectstart",function(){return!1});b(document).bind("mouseup.jqGrid"+a.p.id,function(){return c.resizing?(c.dragEnd(),!1):!0});a.formatCol=p;a.sortData=pa;a.updatepager=function(c,
d){var e,f,g,h,k,l,m,n="",p=a.p.pager?"_"+b.jgrid.jqID(a.p.pager.substr(1)):"",r=a.p.toppager?"_"+a.p.toppager.substr(1):"";g=parseInt(a.p.page,10)-1;0>g&&(g=0);g*=parseInt(a.p.rowNum,10);k=g+a.p.reccount;if(a.p.scroll){e=b("tbody:first > tr:gt(0)",a.grid.bDiv);g=k-e.length;a.p.reccount=e.length;if(e=e.outerHeight()||a.grid.prevRowHeight)f=g*e,m=parseInt(a.p.records,10)*e,b(">div:first",a.grid.bDiv).css({height:m}).children("div:first").css({height:f,display:f?"":"none"}),0==a.grid.bDiv.scrollTop&&
...
m.length&&(h=1);if(m.length!==h||0===c[a[e]]&&"00"!==b[e]||-1===f)return!1;m=c[a[f]].toString();if(1>m.length||1>c[a[f]]||12<c[a[f]]||-1===g)return!1;m=c[a[g]].toString();if(!(h=1>m.length)&&!(h=1>c[a[g]])&&!(h=31<c[a[g]])){if(h=2===c[a[f]])e=c[a[e]],h=c[a[g]]>(0!==e%4||0===e%100&&0!==e%400?28:29);h=h||c[a[g]]>k[c[a[f]]]}return h?!1:!0},isEmpty:function(a){return a.match(/^\s+$/)||""===a?!0:!1},checkTime:function(d){var b=/^(\d{1,2}):(\d{2})([apAP][Mm])?$/;if(!a.jgrid.isEmpty(d))if(d=d.match(b)){if(d[3]){if(1>
...
form:b[c.p.id].form})):b[c.p.id].clearAfterAdd&&w("_empty",c,h)):(b[c.p.id].reloadAfterSubmit?(a(c).trigger("reloadGrid"),b[c.p.id].closeAfterEdit||setTimeout(function(){a(c).jqGrid("setSelection",l[m])},1E3)):!0===c.p.treeGrid?a(c).jqGrid("setTreeRow",l[m],l):a(c).jqGrid("setRowData",l[m],l),b[c.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(u.themodal),{gb:"#gbox_"+a.jgrid.jqID(v),jqm:d.jqModal,onClose:b[c.p.id].onClose,removemodal:b[c.p.id].removemodal,formprop:!b[c.p.id].recreateForm,
form:b[c.p.id].form})),a.isFunction(b[c.p.id].afterComplete)&&(e=s,setTimeout(function(){a(c).triggerHandler("jqGridAddEditAfterComplete",[e,l,a("#"+h),B]);b[c.p.id].afterComplete.call(c,e,l,a("#"+h),B);e=null},500)),b[c.p.id].checkOnSubmit||b[c.p.id].checkOnUpdate)if(a("#"+h).data("disabled",!1),"_empty"!==b[c.p.id]._savedData[c.p.id+"_id"])for(q in b[c.p.id]._savedData)b[c.p.id]._savedData.hasOwnProperty(q)&&l[q]&&(b[c.p.id]._savedData[q]=l[q]);b[c.p.id].processing=!1;try{a(":input:visible","#"+
h)[0].focus()}catch(r){}}},a.jgrid.ajaxOptions,b[c.p.id].ajaxEditOptions);r.url||b[c.p.id].useDataProxy||(a.isFunction(c.p.dataProxy)?b[c.p.id].useDataProxy=!0:(f[0]=!1,f[1]+=" "+a.jgrid.errors.nourl));f[0]&&(b[c.p.id].useDataProxy?(s=c.p.dataProxy.call(c,r,"set_"+c.p.id),void 0===s&&(s=[!0,""]),!1===s[0]?(f[0]=!1,f[1]=s[1]||"Error deleting the selected row!"):(r.data.oper===g.addoper&&b[c.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(u.themodal),{gb:"#gbox_"+a.jgrid.jqID(v),jqm:d.jqModal,
onClose:b[c.p.id].onClose,removemodal:b[c.p.id].removemodal,formprop:!b[c.p.id].recreateForm,form:b[c.p.id].form}),r.data.oper===g.editoper&&b[c.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(u.themodal),{gb:"#gbox_"+a.jgrid.jqID(v),jqm:d.jqModal,onClose:b[c.p.id].onClose,removemodal:b[c.p.id].removemodal,formprop:!b[c.p.id].recreateForm,form:b[c.p.id].form}))):"clientArray"===r.url?(b[c.p.id].reloadAfterSubmit=!1,l=r.data,r.complete({status:200,statusText:""},"")):a.ajax(r))}!1===f[0]&&
(a("#FormError>td",n).html(f[1]),a("#FormError",n).show())}function m(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&a[d]!=b[d]){c=!0;break}return c}function f(){var d=!0;a("#FormError",n).hide();b[c.p.id].checkOnUpdate&&(l={},e(),M=m(l,b[c.p.id]._savedData))&&(a("#"+h).data("disabled",!0),a(".confirm","#"+u.themodal).show(),d=!1);return d}function g(){var b;if("_empty"!==z&&void 0!==c.p.savedRow&&0<c.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<c.p.savedRow.length;b++)if(c.p.savedRow[b].id==
z){a(c).jqGrid("restoreRow",z);break}}function q(b,c){var d=c[1].length-1;0===b?a("#pData",n+"_2").addClass("ui-state-disabled"):void 0!==c[1][b-1]&&a("#"+a.jgrid.jqID(c[1][b-1])).hasClass("ui-state-disabled")?a("#pData",n+"_2").addClass("ui-state-disabled"):a("#pData",n+"_2").removeClass("ui-state-disabled");b===d?a("#nData",n+"_2").addClass("ui-state-disabled"):void 0!==c[1][b+1]&&a("#"+a.jgrid.jqID(c[1][b+1])).hasClass("ui-state-disabled")?a("#nData",n+"_2").addClass("ui-state-disabled"):a("#nData",
n+"_2").removeClass("ui-state-disabled")}function x(){var b=a(c).jqGrid("getDataIDs"),d=a("#id_g",n).val();return[a.inArray(d,b),b]}var c=this;if(c.grid&&z){var v=c.p.id,h="FrmGrid_"+v,r="TblGrid_"+v,n="#"+a.jgrid.jqID(r),u={themodal:"editmod"+v,modalhead:"edithd"+v,modalcontent:"editcnt"+v,scrollelm:h},y=a.isFunction(b[c.p.id].beforeShowForm)?b[c.p.id].beforeShowForm:!1,C=a.isFunction(b[c.p.id].afterShowForm)?b[c.p.id].afterShowForm:!1,A=a.isFunction(b[c.p.id].beforeInitData)?b[c.p.id].beforeInitData:
!1,E=a.isFunction(b[c.p.id].onInitializeForm)?b[c.p.id].onInitializeForm:!1,s=!0,D=1,I=0,l,M,B,h=a.jgrid.jqID(h);"new"===z?(z="_empty",B="add",d.caption=b[c.p.id].addCaption):(d.caption=b[c.p.id].editCaption,B="edit");d.recreateForm||a(c).data("formProp")&&a.extend(b[a(this)[0].p.id],a(c).data("formProp"));var N=!0;d.checkOnUpdate&&d.jqModal&&!d.modal&&(N=!1);var F=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",s=isNaN(b[a(this)[0].p.id].datawidth)?
...
if(c.length)for(f in c)c.hasOwnProperty(f)&&(c[f][e]=parseInt(c[f][e],10)-g)}}})},addChildNode:function(b,c,a,h){var e=this[0];if(a){var l=e.p.treeReader.expanded_field,g=e.p.treeReader.leaf_field,f=e.p.treeReader.level_field,n=e.p.treeReader.parent_id_field,m=e.p.treeReader.left_field,p=e.p.treeReader.right_field,q=e.p.treeReader.loaded,k,u,t,w,s;k=0;var v=c,x;void 0===h&&(h=!1);if(void 0===b||null===b){s=e.p.data.length-1;if(0<=s)for(;0<=s;)k=Math.max(k,parseInt(e.p.data[s][e.p.localReader.id],
10)),s--;b=k+1}var y=d(e).jqGrid("getInd",c);x=!1;void 0===c||null===c||""===c?(v=c=null,k="last",w=e.p.tree_root_level,s=e.p.data.length+1):(k="after",u=e.p._index[c],t=e.p.data[u],c=t[e.p.localReader.id],w=parseInt(t[f],10)+1,s=d(e).jqGrid("getFullTreeNode",t),s.length?(v=s=s[s.length-1][e.p.localReader.id],s=d(e).jqGrid("getInd",v)+1):s=d(e).jqGrid("getInd",c)+1,t[g]&&(x=!0,t[l]=!0,d(e.rows[y]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(e.p.treeIcons.leaf+
...
(function(e){function K(e,m){var f,c,k=[],q;if(!this||"function"!==typeof e||e instanceof RegExp)throw new TypeError;q=this.length;for(f=0;f<q;f++)if(this.hasOwnProperty(f)&&(c=this[f],e.call(m,c,f,this))){k.push(c);break}return k}e.assocArraySize=function(e){var m=0,f;for(f in e)e.hasOwnProperty(f)&&m++;return m};e.jgrid.extend({pivotSetup:function(s,m){var f=[],c=[],k=[],q=[],H=[],g={grouping:!0,groupingView:{groupField:[],groupSummary:[],groupSummaryPos:[]}},n=[],b=e.extend({rowTotals:!1,rowTotalsText:"Total",
colTotals:!1,groupSummary:!0,groupSummaryPos:"header",frozenStaticCols:!1},m||{});this.each(function(){function m(B,b,a){B=K.call(B,b,a);return 0<B.length?B[0]:null}function L(B,b){var a=0,e=!0,f;for(f in B){if(B[f]!=this[a]){e=!1;break}a++;if(a>=this.length)break}e&&(E=b);return e}function F(b,a,f,g){var h=a.length,z,d,c,n,l="",m=[];e.isArray(f)?(n=f.length,m=f):(n=1,m[0]=f);q=[];H=[];for(c=q.root=0;c<n;c++){var p=[],k;for(z=0;z<h;z++){if(null==f)k=d=e.trim(a[z].member)+"_"+a[z].aggregator,m[0]=
k;else{k=f[c].replace(/\s+/g,"");try{d=1===h?l+k:l+k+"_"+a[z].aggregator+"_"+String(z)}catch(w){}}d=isNaN(parseInt(d,10))?d:d+" ";var u=g,x=d,y=p,A=d,v=g[d],r=a[z].member,s=b,t=void 0;switch(a[z].aggregator){case "sum":t=parseFloat(v||0)+parseFloat(s[r]||0);break;case "count":if(""===v||null==v)v=0;t=s.hasOwnProperty(r)?v+1:0;break;case "min":t=""===v||null==v?parseFloat(s[r]||0):Math.min(parseFloat(v),parseFloat(s[r]||0));break;case "max":t=""===v||null==v?parseFloat(s[r]||0):Math.max(parseFloat(v),
parseFloat(s[r]||0))}u[x]=y[A]=t;1>=c&&"_r_Totals"!==k&&""===l&&(l=k)}q[d]=p;H[d]=m[c]}return g}function J(a){var e,d,g,h,c;for(g in a)if(a.hasOwnProperty(g)){if("object"!==typeof a[g]){if("level"===g){void 0===G[a.level]&&(G[a.level]="",0<a.level&&"_r_Totals"!==a.text&&(n[a.level-1]={useColSpanStyle:!1,groupHeaders:[]}));if(G[a.level]!==a.text&&a.children.length&&"_r_Totals"!==a.text&&0<a.level){n[a.level-1].groupHeaders.push({titleText:a.label,numberOfColumns:0});d=n[a.level-1].groupHeaders.length-
1;c=0===d?M:I+C;if(a.level-1===(b.rowTotals?1:0)&&0<d){var k=n[a.level-1].groupHeaders[d-1].numberOfColumns;k&&(c=k+1+b.aggregates.length)}n[a.level-1].groupHeaders[d].startColumnName=f[c].name;n[a.level-1].groupHeaders[d].numberOfColumns=f.length-c;I=f.length}G[a.level]=a.text}if(a.level===l&&"level"===g&&0<l)if(1<C){d=1;for(e in a.fields)1===d&&n[l-1].groupHeaders.push({startColumnName:e,numberOfColumns:1,titleText:a.text}),d++;n[l-1].groupHeaders[n[l-1].groupHeaders.length-1].numberOfColumns=d-
1}else n.splice(l-1,1)}null!=a[g]&&"object"===typeof a[g]&&J(a[g]);if("level"===g&&0<a.level)for(e in d=0,a.fields)if(a.fields.hasOwnProperty(e)){c={};for(h in b.aggregates[d])if(b.aggregates[d].hasOwnProperty(h))switch(h){case "member":case "label":case "aggregator":break;default:c[h]=b.aggregates[d][h]}1<C?(c.name=e,c.label=b.aggregates[d].label||a.label):(c.name=a.text,c.label="_r_Totals"===a.text?b.rowTotalsText:a.label);f.push(c);d++}}}var p,E,a,A=s.length,t,l,C,d,r=0;b.rowTotals&&0<b.yDimension.length&&
(b.yDimension.splice(0,0,{dataName:b.yDimension[0].dataName}),b.yDimension[0].converter=function(){return"_r_Totals"});t=e.isArray(b.xDimension)?b.xDimension.length:0;l=b.yDimension.length;C=e.isArray(b.aggregates)?b.aggregates.length:0;if(0===t||0===C)throw"xDimension or aggregates optiona are not set!";var x;for(a=0;a<t;a++)x={name:b.xDimension[a].dataName,frozen:b.frozenStaticCols},null==b.xDimension[a].isGroupField&&(b.xDimension[a].isGroupField=!0),x=e.extend(!0,x,b.xDimension[a]),f.push(x);
x=t-1;for(var D={};r<A;){p=s[r];var w=[],u=[];d={};a=0;do w[a]=e.trim(p[b.xDimension[a].dataName]),d[b.xDimension[a].dataName]=w[a],a++;while(a<t);var h=0;E=-1;a=m(c,L,w);if(!a){h=0;if(1<=l){for(h=0;h<l;h++)u[h]=e.trim(p[b.yDimension[h].dataName]),b.yDimension[h].converter&&e.isFunction(b.yDimension[h].converter)&&(u[h]=b.yDimension[h].converter.call(this,u[h],w,u));d=F(p,b.aggregates,u,d)}else 0===l&&(d=F(p,b.aggregates,null,d));c.push(d)}else if(0<=E){h=0;if(1<=l){for(h=0;h<l;h++)u[h]=e.trim(p[b.yDimension[h].dataName]),
b.yDimension[h].converter&&e.isFunction(b.yDimension[h].converter)&&(u[h]=b.yDimension[h].converter.call(this,u[h],w,u));a=F(p,b.aggregates,u,a)}else 0===l&&(a=F(p,b.aggregates,null,a));c[E]=a}p=0;var w=d=null,y;for(y in q)if(q.hasOwnProperty(y)){if(0===p)D.children&&void 0!==D.children||(D={text:y,level:0,children:[],label:y}),d=D.children;else{w=null;for(a=0;a<d.length;a++)if(d[a].text===y){w=d[a];break}w?d=w.children:(d.push({children:[],text:y,level:p,fields:q[y],label:H[y]}),d=d[d.length-1].children)}p++}r++}var G=
[],I=f.length,M=I;0<l&&(n[l-1]={useColSpanStyle:!1,groupHeaders:[]});J(D);if(b.colTotals)for(r=c.length;r--;)for(a=t;a<f.length;a++)A=f[a].name,k[A]=k[A]?k[A]+parseFloat(c[r][A]||0):parseFloat(c[r][A]||0);if(0<x)for(a=0;a<x;a++)f[a].isGroupField&&(g.groupingView.groupField.push(f[a].name),g.groupingView.groupSummary.push(b.groupSummary),g.groupingView.groupSummaryPos.push(b.groupSummaryPos));else g.grouping=!1;g.sortname=f[x].name;g.groupingView.hideFirstGroupCol=!0});return{colModel:f,rows:c,groupOptions:g,
groupHeaders:n,summary:k}},jqPivot:function(s,m,f,c){return this.each(function(){function k(c){var g=jQuery(q).jqGrid("pivotSetup",c,m),k=0<e.assocArraySize(g.summary)?!0:!1,b=e.jgrid.from(g.rows);for(c=0;c<g.groupOptions.groupingView.groupField.length;c++)b.orderBy(g.groupOptions.groupingView.groupField[c],"a","text","");jQuery(q).jqGrid(e.extend(!0,{datastr:e.extend(b.select(),k?{userdata:g.summary}:{}),datatype:"jsonstring",footerrow:k,userDataOnFooter:k,colModel:g.colModel,viewrecords:!0,sortname:m.xDimension[0].dataName},
g.groupOptions,f||{}));g=g.groupHeaders;if(g.length)for(c=0;c<g.length;c++)g[c]&&g[c].groupHeaders.length&&jQuery(q).jqGrid("setGroupHeaders",g[c]);m.frozenStaticCols&&jQuery(q).jqGrid("setFrozenColumns")}var q=this;"string"===typeof s?e.ajax(e.extend({url:s,dataType:"json",success:function(f){k(e.jgrid.getAccessor(f,c&&c.reader?c.reader:"rows"))}},c||{})):k(s)})}})})(jQuery);
